...
export default function Home() {
    return (
        <div
            ...
            min-h-screen w-full max-w-[56.75rem] p-4 pb-20 gap-16  font-[family-name:var(--font-ubuntu)]"
        >
            <main
            ...
            >
                <div
                    ...
                    sm:w-[300px] sm:min-h-[35.5rem] absolute top-0 left-0 sm:h-auto sm:relative sm:flex sm:flex-col 
